            ...
            <div className="uk-flex ul-flex-center uk-margin-large-top uk-flex-middle uk-grid">
                ...
                <div className="uk-width-expand uk-margin uk-text-left@m uk-first-column">
                    <h5 className="uk-text-muted uk-margin-remove" uk-scrollspy="cls: uk-animation-slide-left-small; repeat: true">
                        Olá, sou Guilherme Andrade Lacerda, desenvolvedor fullstack, acadêmico de Sistemas de Informação, cursando o 7º período. Atualmente trabalho como Auxiliar Administrativo de TI no UNITPAC - Centro Universitário Tocantinense Presidente Antônio Carlos.
                        </h5>
                    <br />
                    <h5 className="uk-text-muted uk-margin-remove" uk-scrollspy="cls: uk-animation-slide-left-small; repeat: true">
                    ...
                    <br />
                    <h5 className="uk-text-muted uk-margin-remove" uk-scrollspy="cls: uk-animation-slide-left-small; repeat: true">
                        Amo aprender e ensinar, procuro sempre compartilhar meus conhecimentos com outras pessoas, nas horas vagas escrevo alguns artigos no Medium de algo que aprendi ou assuntos pouco falados lá.
                        </h5>
                </div>
            </div>
        </div>

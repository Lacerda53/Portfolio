        ...
        <div id="contact" className="uk-container uk-flex uk-flex-column uk-flex-middle uk-flex-center uk-section">
            ...
            <div className="uk-margin-large-top">
                <h4 className="uk-margin-remove">
                    <span className="uk-margin-small-top uk-text-muted uk-margin-small-right" uk-icon="icon: mail;ratio: 1.5"></span>
                    <a className="uk-text-green" target="_blank" href="mailto:guilhermeandrade2013@gmail.com">guilhermeandrade2013@gmail.com</a>
                </h4>
                <h4 className="uk-margin-remove">
                    <span className="uk-margin-small-top uk-text-muted uk-margin-small-right" uk-icon="icon: whatsapp;ratio: 1.5"></span>
                    <a className="uk-text-green" target="_blank" href="https://api.whatsapp.com/send?phone=5594992643424">+55 (94) 99264-3424</a>
                </h4>
                <h4 className="uk-margin-remove">
                    <span className="uk-margin-small-top uk-text-muted uk-margin-small-right" uk-icon="icon: location;ratio: 1.5"></span>
